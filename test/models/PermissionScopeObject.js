...
var request = null;
var urlResource = '/appdev-core/permissionscopeobject';

describe('PermissionScopeObject tests ', function(){
    ...
    // PermissionScopeObject exists
    it('should be there :: ', function() {
        assert.isDefined(PermissionScopeObject, ' --> PARequest should be defined!');
    });
