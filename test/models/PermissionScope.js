...
var request = null;
var urlResource = '/appdev-core/permissionscope';

describe('PermissionScope tests ', function(){
    ...
    // PermissionScope exists
    it('should be there', function() {
        assert.isDefined(PermissionScope, ' --> PermissionScope should be defined!');
    });
